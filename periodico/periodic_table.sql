...
--
-- Name: elements pkey_elements; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT pkey_elements PRIMARY KEY (atomic_number);


--
-- Name: properties pkey_properties; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT pkey_properties PRIMARY KEY (atomic_number);
...
--
-- Name: elements unique_elements; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_elements UNIQUE (atomic_number);


--
-- Name: properties unique_properties; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT unique_properties UNIQUE (atomic_number);
